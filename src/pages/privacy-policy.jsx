const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto px-8 py-20 text-neutral-300">
      ...
      <p className="text-sm text-neutral-400">Last updated: August 26, 2025</p>
      ...
      <div className="mt-8 space-y-6">
        ...
        <h2 className="text-2xl md:text-3xl font-semibold mt-10 mb-2">
          Interpretation and Definitions
        </h2>
        <h3 className="text-xl md:text-2xl font-medium">Interpretation</h3>
        <p className="leading-relaxed">
        ...
        <h3 className="text-xl md:text-2xl font-medium">Definitions</h3>
        <p className="leading-relaxed">
        ...
        <ul className="list-disc list-inside space-y-3">
          <li>
            <p>
              <strong className="text-cyan-300">Account</strong> means a unique
          ...
          <li>
            <p>
              <strong className="text-cyan-300">Affiliate</strong> means an
          ...
          <li>
            <p>
              <strong className="text-cyan-300">Application</strong> refers to
              xpose, the software program provided by the Company.
            </p>
          </li>
          <li>
            <p>
              <strong className="text-cyan-300">Company</strong> (referred to as
              either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
              &quot;Our&quot; in this Agreement) refers to Tarech Studios,
              241-50100, Kakamega.
            </p>
          </li>
          <li>
            <p>
              <strong className="text-cyan-300">Cookies</strong> are small files
          ...
          <li>
            <p>
              <strong className="text-cyan-300">Country</strong> refers to:
              Kenya
            </p>
          </li>
          <li>
            <p>
              <strong className="text-cyan-300">Device</strong> means any device
          ...
          <li>
            <p>
              <strong className="text-cyan-300">Personal Data</strong> is any
          ...
          <li>
            <p>
              <strong className="text-cyan-300">Service</strong> refers to the
              Application or the Website or both.
            </p>
          </li>
          <li>
            <p>
              <strong className="text-cyan-300">Service Provider</strong> means
          ...
          <li>
            <p>
              <strong className="text-cyan-300">Usage Data</strong> refers to
          ...
          <li>
            <p>
              <strong className="text-cyan-300">Website</strong> refers to
              Chanzu, accessible from{" "}
              <a
                href="https://www.chanzu.vercel.app"
                rel="external nofollow noopener"
                target="_blank"
                className="text-cyan-400 hover:underline"
              >
                https://www.chanzu.vercel.app
              </a>
            </p>
          </li>
          <li>
            <p>
              <strong className="text-cyan-300">You</strong> means the
        ...
        {/* The rest of the content has similar styling applied */}
        <h2 className="text-2xl md:text-3xl font-semibold mt-10 mb-2">
        ...
        <ul className="list-disc list-inside">
          <li>
            <p className="leading-relaxed">Email address</p>
          </li>
          <li>
            <p className="leading-relaxed">First name and last name</p>
          </li>
          <li>
            <p className="leading-relaxed">Phone number</p>
          </li>
          <li>
            <p className="leading-relaxed">Usage Data</p>
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>
            <strong className="text-cyan-300">Web Beacons.</strong> Certain
        ...
        <ul className="list-disc list-inside space-y-6">
          ...
          <li>
            <p>
              <strong className="text-cyan-300">Functionality Cookies</strong>
            </p>
            <p className="text-sm">Type: Persistent Cookies</p>
            <p className="text-sm">Administered by: Us</p>
            <p className="leading-relaxed">
        ...
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>
            <p>
              <strong className="text-cyan-300">To manage Your Account:</strong>{" "}
          ...
          <li>
            <p>
              <strong className="text-cyan-300">To contact You:</strong> To
          ...
          <li>
            <p>
              <strong className="text-cyan-300">To provide You</strong> with
          ...
          <li>
            <p>
              <strong className="text-cyan-300">For business transfers:</strong>{" "}
          ...
          <li>
            <p>
              <strong className="text-cyan-300">For other purposes</strong>: We
        ...
        <ul className="list-disc list-inside space-y-3">
          <li>
            <strong className="text-cyan-300">With Service Providers:</strong>{" "}
          ...
          <li>
            <strong className="text-cyan-300">With Affiliates:</strong> We may
          ...
          <li>
            <strong className="text-cyan-300">With business partners:</strong>{" "}
            We may share Your information with Our business partners to offer
            You certain products, services or promotions.
          </li>
          <li>
            <strong className="text-cyan-300">With other users:</strong> when
          ...
          <li>
            <strong className="text-cyan-300">With Your consent</strong>: We may
            disclose Your personal information for any other purpose with Your
            consent.
          </li>
        </ul>

        <h3 className="text-xl md:text-2xl font-medium mt-10 mb-2">
        ...
        <ul className="list-disc list-inside">
          <li>
            By email:{" "}
            <a
              href="mailto:tarechstudios@gmail.com"
              className="text-cyan-400 hover:underline"
            >
              tarechstudios@gmail.com
            </a>
          </li>
        </ul>
      </div>
